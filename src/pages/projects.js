    ...
    <section>
      <div className="row">
        <div className="col-12 col-md-6">
          <Project title="TRIPBY" url="http://tripby.org">
        ...
        <div className="col-12 col-md-6">
          <Project title="Corinthians-Guarulhos" url="http://corinthiansguarulhos.com">
        ...
        <div className="col-12 col-md-6">
          <Project title="Softin Sistemas" url="http://softin.com.br">
